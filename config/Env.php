...
return [
    ...
    'url_parser' => 'presty\Router\Driver\Presty',                 //系统默认使用的路由引擎，需要与对应的路由引擎类名保持一致
    'template_parser' => 'presty\View\Driver\View',                //系统默认使用的路由引擎，需要与对应的路由引擎类名保持一致
    '404_template' => '',                                          //默认404页面
    'run_exception_template' => 'RunException',                    //默认异常抛出页面
];